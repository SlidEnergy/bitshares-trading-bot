...
var MarketUtils = {
    ...
    getFeedPrice: function getFeedPrice(settlement_price) {
        ...
        var quoteAsset = _bitsharesjs.ChainStore.getAsset(settlement_price.getIn(["quote", "asset_id"]));
        var baseAsset = _bitsharesjs.ChainStore.getAsset(settlement_price.getIn(["base", "asset_id"]));
